...
<head>
  ...
  <style>
    * {
    ...
    /* Styles for the DB data section */
    #db-content {
      max-width: 1200px;
      margin: 2rem auto;
      background: white;
...
<body>
  ...
  <section class="hero" aria-label="Sikar overview and image">
    <div class="hero-img" role="img" aria-label="Image of Sikar city">
      <img
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-IiYO4LvqFO3OMxixSWjgIHbTLWWd0ivybQ&s"
        alt="Sikar city"
        id="sikarImg"
        loading="lazy"
      />
    ...
    <div class="hero-content">
      ...
      <p>
        Sikar is a historical city in Rajasthan, known for its grand havelis, forts and rich cultural heritage. It is famous for its beautiful architecture and vibrant festivals.
      </p>
     <button class="btn-primary" id="toggleDBBtn" onclick="toggleCityData()">Show More</button>
  ...
  <!-- New section to load DB content from PHP via AJAX -->
  <section id="db-content">
   
    <div id="cityData" style="margin-top:1rem;"></div>
  </section>
    ...
    <div class="footer-container">
      <div class="footer-section footer-links" aria-label="Explore cities links">
        ...
        <ul>
          ...
          <li><a href="kota.html">Kota</a></li>
          <li><a href="fatehpur.html">Fatehpur</a></li>
          <li><a href="ratangarh.html" aria-current="page">Ratangarh</a></li>
          <li><a href="delhi.html">Delhi</a></li>
        </ul>
      </div>
